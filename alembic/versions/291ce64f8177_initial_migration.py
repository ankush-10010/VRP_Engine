...
Revision ID: 291ce64f8177
Revises: 
Create Date: 2026-01-11 14:45:40.636725
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('original_address')
    )
    op.create_index(op.f('ix_geocoded_locations_original_address'), 'geocoded_locations', ['original_address'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_geocoded_locations_original_address'), table_name='geocoded_locations')
